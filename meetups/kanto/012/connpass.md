...
- アイマスハッカソンに向けた下準備をする
- アイマスに関連したお絵かきをする
- [トークイベント](https://imas.connpass.com/event/186165/)に向けた資料作りをする
...
ツールは[トークイベント](https://imas.connpass.com/event/186165/)の懇親会で使用するSpatialChatを利用する予定です。

当日の時間になりましたら部屋のリンクをSlackにてお知らせします。
